  ...
  return (
    <div className="bg-white text-slate-800 min-h-screen font-sans flex items-center justify-center px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-md w-full text-center relative z-10">
        ...
        <div className="inline-flex p-4 rounded-full bg-[#ED1C24]/10 text-[#ED1C24] mb-6 animate-pulse">
          <AlertCircle size={48} />
        </div>
        
        <h1 className="text-7xl font-extrabold text-slate-900 tracking-tighter">
          4<span className="text-[#ED1C24]">0</span>4
        </h1>
        ...
        <p className="mt-3 text-slate-500 text-sm leading-relaxed">
          The engine lubricant specification or page you are looking for doesn&apos;t exist. It might have been moved or deleted permanently.
        </p>
